# 🎯 TABLERO DE MISIONES (ÓRDENES)

Este archivo es la fuente de verdad de las tareas delegadas entre agentes y el Comandante Humano.
**Todo agente debe revisar este archivo antes de iniciar su rutina y actualizar su estado.**

Estados válidos: `[ ]` (Pendiente) -> `[/]` (En progreso) -> `[x]` (Completado)
...
*(Las tareas con `[x]` se moverán aquí periódicamente para mantener el tablero limpio)*
