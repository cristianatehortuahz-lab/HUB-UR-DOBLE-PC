...
${stylesheets.add('
    <link rel="stylesheet" type="text/css" href="${urls.base}/themes/wilma/css/menuPageOrganization.css"/>', '
    <link rel="stylesheet" type="text/css" href="${urls.base}/themes/wilma/css/pure_dashboard_hub_v23.css"/>')}
  ...
  <section id="browse-by" class="container-fluid" role="region">
    <div class="row">
      ...
      <!-- Selector de letras A-Z -->
        <nav id="alpha-browse-container" class="mt-2 d-flex justify-content-end" role="navigation">
        ...
        <section id="individuals-in-class" role="region">
          <ul id="milista" class="row g-3" role="list">
