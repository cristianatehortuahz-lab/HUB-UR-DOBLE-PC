                        ...
                        <#if (group.individualCount > 0)>
                            ...
                            <#if !group.uri?contains("equipment") && !group.uri?contains("course") >
                                <li>
                                    ...
                                    <#-- Minimalist redesign: Images removed -->
                    ...
                    <#--<#if (groupCount > 6) >
                        ...
                        <#if (group.individualCount > 0)>
                            <#if group.uri?contains("http://vivoweb.org/ontology#vitroClassGrouppeople")>
                                <#assign totalCount = 0>
                                <#list group.classes as class>
                                    <#if class.uri?contains("FacultyMember") || class.uri?contains("NonFacultyAcademic")>
                                        <#assign totalCount = totalCount + class.individualCount>
                            ...
                            <#elseif group.uri?contains("http://vivoweb.org/ontology#vitroClassGrouporganizations")>
                                <#list group.classes as class>
                                    <#if class.uri?contains("CoreLaboratory")>
                                        <#assign totalCountCoreLaboratory = class.individualCount>
                                        
                                    <#elseif class.uri?contains("Program")>
                                        <#assign totalCountProgram = class.individualCount>
                                ...
                                <li class="stats-item">
                                    <a href="/research" title="${group.displayName?capitalize}">
                                        ...
                                        <#--  <p class="stats-description">${group.displayName?capitalize}</p>  -->
                                            <p class="stats-description">${i18n().URPublication}</p>
                                    </a>
                                </li>
                            </#if>
                        </#if>
